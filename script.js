...
function toggleTimer() {
    if (isRunning) {
        ...
        startBtn.innerHTML = '<span class="button-icon">🦁</span> Iniciar';
    } else {
        timerId = setInterval(() => {
            if (timeLeft > 0) {
                timeLeft--;
        ...
        startBtn.innerHTML = '<span class="button-icon">🦁</span> Pausar';
    }
    isRunning = !isRunning;
}
...
function switchMode() {
    ...
    modeText.textContent = isWorkMode ? 'Tiempo de Trabajo' : 'Tiempo de Descanso';
    modeBtn.innerHTML = isWorkMode 
        ? '<span class="button-icon">🦥</span> Descansar'
        : '<span class="button-icon">🦘</span> Trabajar';
...
// Inicializar
initTimer();
modeBtn.innerHTML = '<span class="button-icon">🦥</span> Descansar';
